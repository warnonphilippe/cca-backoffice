package be.civadis.backoffice.repository;

import be.civadis.backoffice.BackofficeApp;
import be.civadis.backoffice.config.Constants;
import be.civadis.backoffice.config.audit.AuditEventConverter;
import be.civadis.backoffice.domain.PersistentAuditEvent;
...
import static be.civadis.backoffice.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
